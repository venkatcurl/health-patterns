...
def resource_relevant_to_any_type_names(
    ...
    """For the given resource class, determine if any of the type names are relevant for that type of resource
...
def ref_type_relevant_to_any_type_names(
    ...
    """For the given concept ref type, determine if any of the type names are relevant for that concept
